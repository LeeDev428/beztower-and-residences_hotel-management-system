    ...
    <form method="POST" action="{{ route('admin.rooms.update', $room) }}" enctype="multipart/form-data">
        ...
        <div style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; margin-bottom: 1.5rem;">
            ...
            <div>
                ...
                <input type="number" name="floor" value="{{ old('floor', $room->floor) }}" required min="2" max="8" step="1" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-gray); border-radius: 8px;">
            ...
            <div>
                ...
                <input type="number" name="discount_percentage" value="{{ old('discount_percentage', (float) ($room->discount_percentage ?? 0)) }}" min="0" max="100" step="5" style="width: 100%; padding: 0.75rem; border: 1px solid var(--border-gray); border-radius: 8px;">
                <small style="color: #666; font-size: 0.875rem;">Allowed values: 0, 5, 10, 15, ... 100</small>
