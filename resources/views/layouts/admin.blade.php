    ...
    <aside class="sidebar" id="sidebar">
        ...
        <nav class="sidebar-nav">
            ...
            <div class="nav-section">
                ...
                <a href="{{ route('admin.bookings.index') }}" class="nav-link {{ request()->routeIs('admin.bookings.*') && !request()->routeIs('admin.bookings.walkIn*') ? 'active' : '' }}">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="{{ route('admin.bookings.walkIn') }}" class="nav-link {{ request()->routeIs('admin.bookings.walkIn*') ? 'active' : '' }}" style="padding-left: 2.5rem; font-size: 0.85rem;">
                    <svg class="nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="width: 16px; height: 16px;">
    ...
    <div class="main-wrapper">
        ...
        <header class="topbar">
            ...
            <div class="topbar-right">
                <a href="{{ route('admin.bookings.index', ['status' => 'pending']) }}" class="notification-btn" title="View pending notifications">
                    <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
